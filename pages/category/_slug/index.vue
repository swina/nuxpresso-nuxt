<template>
    <div>
        ...
        <!--
         <nuxpresso-moka-template v-if="articles && articlesList" :template="default_component.json" :article="articlesList" :pagination="true" :start="start" :limit="limit"/>
        -->
        <nuxpresso-moka-template :template="loop_template.json" :article="articlesList" :pagination="true" :start="start" :limit="limit"/>
        <!--
        <h1>COMPONENT</h1>
        {{component.json}}
        {{ articles }}
